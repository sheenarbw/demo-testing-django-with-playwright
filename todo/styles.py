...
styles = {
    ...
    "button_secondary": f"rounded bg-{secondary_color}-600 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-{secondary_color}-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-{secondary_color}-600",
